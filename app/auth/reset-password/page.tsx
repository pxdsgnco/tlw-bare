        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
          <div>
            ...
            <input
              ...
              autoComplete="email"
              required
              className="appearance-none relative block w-full px-3 py-2 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-md focus:outline-none focus:ring-[#fb7102] focus:border-[#fb7102] focus:z-10 sm:text-sm mt-1"
          ...
          <div className="text-center">
            <Link href="/auth/login" className="font-medium text-[#fb7102] hover:text-[#e5650a] text-sm">
              ← Back to login
            </Link>
          </div>
        </form>
